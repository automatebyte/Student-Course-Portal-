// Import necessary modules from react-router-dom and Bootstrap
  ...
  return (
    ...
    <nav className="navbar navbar-expand-lg navbar-dark sticky-top">
      <div className="container">
        ...
        {/* Toggle button for collapsing nav items on smaller screens */}
        <button 
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            {/* Home link - active when path is exactly '/' */}
            ...
            {/* Dashboard link - active when path is '/dashboard' */}
            <li className="nav-item">
            ...
            {/* Courses link - active for any path that includes '/courses' */}
            <li className="nav-item">
            ...
            {/* Assignments link - active for any path that includes '/assignments' */}
            <li className="nav-item">
            ...
            {/* Admin link - active when path is '/admin' */}
            <li className="nav-item">
